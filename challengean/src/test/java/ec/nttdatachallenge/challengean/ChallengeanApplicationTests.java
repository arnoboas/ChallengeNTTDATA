package ec.nttdatachallenge.challengean;
...
import ec.nttdatachallenge.challengean.util.Constants;
...
@SpringBootTest(classes=ChallengeanApplicationTests.class)
class ChallengeanApplicationTests {
